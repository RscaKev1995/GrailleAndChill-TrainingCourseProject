...
<template>
  <div class="h-screen flex items-center justify-end">
    ...
    />
    <div
      class="bg-white w-2/5 h-auto rounded-md text-center border-gray-100 drop-shadow-sm p-5 m-8 mx-auto shadow-md"
    >
      <h2 class="text-xl leading-10 tracking-widest">
        Merci pour votre commande. Votre paiement a bien été enregistré. Nous
        préparons votre commande et elle sera bientôt en route pour la
        livraison. Nous vous informerons dès que votre commande sera en route.
